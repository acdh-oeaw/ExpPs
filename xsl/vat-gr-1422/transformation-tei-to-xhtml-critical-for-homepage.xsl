...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:TEI">
        <html lang="en-US">
            <head>
                ...
                <meta name="apple-mobile-web-app-title" content="Expositiones in Psalmos - Vat. gr. 1422"></meta>
                                    ...
                                    <main class="site-main" id="main">
                                        <article>
                                            <header class="entry-header">
                                                <div class="entry-top-thumbnail"><img src="../fundament/images/picture_1.png" alt=""/></div>
        ...
        <p class="manuscript-physical-description">
            ...
            <img class="layout-description-image">
                <xsl:attribute name="src">
                    <xsl:value-of select="replace(tei:fileDesc/tei:sourceDesc/tei:msDesc/tei:physDesc/tei:objectDesc/tei:layoutDesc/tei:layout/tei:graphic/@url,'images','images-vat-gr-1422')"/>
                </xsl:attribute>
            </img>
    ...
    <xsl:template match="tei:glyph">
        <p class="glyphs">
            <img>
                <xsl:attribute name="src">
                    <xsl:value-of select="replace(tei:figure/tei:graphic/@url,'images','images-vat-gr-1422')"/>
                </xsl:attribute>
            </img>
    ...
    <xsl:template match="tei:quote[@type = 'patristic']">
        ...
        <xsl:if test="exists(parent::tei:seg/@copyOf)">
            ...
            <xsl:element name="a">
                <xsl:choose>
                    <xsl:when test="starts-with(parent::tei:seg/@copyOf,'#edition-part-two:')">
                        <xsl:attribute name="href" select="concat('../edition-part-two.html#',substring-after(parent::tei:seg/@copyOf,'#edition-part-two:'))"/>
                        <xsl:attribute name="target" select="'_blank'"/>
                        <xsl:text>→ Edition</xsl:text>
                    </xsl:when>
                    <xsl:otherwise>
