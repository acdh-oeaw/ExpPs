...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:teiHeader">
        ...
        <p class="link-to-facsimiles">
            <xsl:text>The facsimiles of the manuscript are available online: </xsl:text>
            <xsl:element name="a">
                <xsl:attribute name="target" select="'_blank'"/>
                <xsl:attribute name="href" select="tei:fileDesc/tei:sourceDesc/tei:msDesc/tei:msIdentifier/tei:idno/@facs"/>
    ...
    <xsl:template match="tei:seg[@type = 'commentaryfragment' or @type = 'hypothesis']">
        <xsl:element name="div">
            ...
            <xsl:if test="(local-name(preceding-sibling::*[1]) = 'note') and exists(preceding-sibling::*[1][@type = 'lemma'])">
                <xsl:element name="p">
